...
export default function GalleryPage() {
  ...
  return (
    <div className="brand-page min-h-svh">
      ...
      <div className="mx-auto max-w-5xl px-6 py-10">
        <div
          className="mb-6 flex items-center justify-between text-sm text-[rgba(43,27,18,0.65)]"
          style={{ fontFamily: "var(--f-body)" }}
        >
          <Link href="/" className="hover:text-[var(--b-ink)]">← Home</Link>
          <div className="flex gap-4">
            <Link href="/dashboard" className="hover:text-[var(--b-ink)]">My invitations</Link>
            <Link href="/login" className="hover:text-[var(--b-ink)]">Log in</Link>
          </div>
        </div>
        ...
        <header className="text-center">
          ...
          <p
            className="mt-3 text-[16px] font-light text-[rgba(43,27,18,0.7)]"
            style={{ fontFamily: "var(--f-body)" }}
          >
          ...
          {COMMUNITIES.map((c) => {
            ...
            return (
              <button
                ...
                style={{
                  background: on ? "var(--b-primary)" : "#fff",
                  color: on ? "var(--b-bg)" : "var(--b-body)",
                  borderColor: on ? "var(--b-primary)" : "rgba(43,27,18,0.12)",
        ...
        {designs === null ? (
          <p
            className="mt-10 text-center text-[rgba(43,27,18,0.5)]"
            style={{ fontFamily: "var(--f-body)" }}
          >
            Loading designs…
          </p>
          ...
          <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {shown.map((it) => (
              <div
                key={it.key}
                className="group overflow-hidden rounded-2xl border border-[rgba(43,27,18,0.15)] bg-white shadow-[0_10px_30px_rgba(43,27,18,0.06)] transition-all hover:-translate-y-1 hover:shadow-[0_24px_50px_rgba(43,27,18,0.14)]"
              >
                <div
                ...
                <div className="p-5">
                  <p
                    className="text-[15px] font-medium text-[var(--b-ink)]"
                    style={{ fontFamily: "var(--f-body)" }}
                  >
                    {it.name}
                  </p>
                  <p
                    className="text-[13px] text-[rgba(43,27,18,0.55)]"
                    style={{ fontFamily: "var(--f-body)" }}
                  >
                  ...
                  <div className="mt-3 flex items-center gap-3">
                    <Link
                      href={it.previewHref}
                      className="rounded-full border border-[rgba(43,27,18,0.2)] px-3.5 py-1.5 text-[11px] font-medium tracking-[0.14em] text-[var(--b-gold)] transition-colors hover:border-[var(--b-gold)] hover:bg-[var(--b-tint)]"
                      style={{ fontFamily: "var(--f-body)" }}
                    >
                      PREVIEW
                    </Link>
                    <Link
                      href={it.href}
                      className="rounded-full bg-[var(--b-primary)] px-3.5 py-1.5 text-[11px] font-medium tracking-[0.14em] text-white transition-colors hover:bg-[var(--b-primary-deep)]"
                      style={{ fontFamily: "var(--f-body)" }}
                    >
                      CUSTOMIZE →
                    </Link>
            ...
            {shown.length === 0 ? (
              <p
                className="col-span-full text-center text-[rgba(43,27,18,0.5)]"
                style={{ fontFamily: "var(--f-body)" }}
              >
