...
export default function AdminSiteSettingsPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-8 sm:px-10 sm:py-10" style={{ fontFamily: "var(--f-body)" }}>
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <nav className="flex items-center gap-1.5 text-[12px] text-[rgba(90,35,56,0.55)]">
            ...
            <span className="text-[rgba(90,35,56,0.75)]">Site Settings</span>
            <span className="text-[rgba(90,35,56,0.3)]">›</span>
      ...
      {/* Table */}
      <div className="mt-6 overflow-x-auto rounded-2xl border border-[rgba(201,73,124,0.15)] bg-white shadow-[0_10px_30px_rgba(122,44,44,0.05)]">
        <table className="w-full text-left text-[13.5px]">
          ...
          <tbody>
            {row ? (
              <tr className="border-t border-[rgba(90,35,56,0.06)] transition-colors hover:bg-[#fdf4ec]/60">
                ...
                <td className="px-5 py-3 align-middle font-medium text-[#5a2338]">
                  {row.branding.brandName || <span className="text-[rgba(90,35,56,0.4)]">— not set —</span>}
                </td>
                <td className="max-w-[220px] truncate px-5 py-3 align-middle text-[rgba(90,35,56,0.75)]" title={row.hero.tagline}>
                  {row.hero.tagline || <span className="text-[rgba(90,35,56,0.35)]">—</span>}
                </td>
                <td className="max-w-[240px] truncate px-5 py-3 align-middle text-[#5a2338]" title={row.hero.heroHeadline}>
                  {row.hero.heroHeadline || <span className="text-[rgba(90,35,56,0.35)]">—</span>}
                </td>
                <td className="px-5 py-3 align-middle">
                  {row.branding.logo ? (
                ...
                <td className="px-5 py-3 align-middle">
                  {row.branding.favicon ? (
                    <span className="inline-flex h-6 w-6 items-center justify-center overflow-hidden rounded-md border border-[rgba(90,35,56,0.1)] bg-[#fdf4ec]">
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                ...
                <td className="px-5 py-3 align-middle text-[rgba(90,35,56,0.65)]">
                  {row.updatedAt ? new Date(row.updatedAt).toLocaleDateString() : "—"}
                </td>
                <td className="whitespace-nowrap px-5 py-3 text-right">
                  <Link
                    href="/admin/site-settings/edit"
                    className="inline-flex items-center gap-1 text-[12.5px] text-[#d95f48] hover:underline"
                  >
              ...
              <tr>
                <td colSpan={8} className="px-5 py-10 text-center text-[rgba(90,35,56,0.45)]">
        ...
        {row ? (
          <div className="flex items-center justify-between border-t border-[rgba(90,35,56,0.08)] bg-[#fdf4ec]/50 px-5 py-3 text-[12.5px] text-[rgba(90,35,56,0.7)]">
            <span>Showing 1 result</span>
            <span className="text-[rgba(90,35,56,0.5)]">Only one site-settings record exists.</span>
          </div>
        ) : null}
      </div>
    </div>
