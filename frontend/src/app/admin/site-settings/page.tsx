...
export default function AdminSiteSettingsPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-8 sm:px-10 sm:py-10" style={{ fontFamily: "var(--f-body)" }}>
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <nav className="flex items-center gap-1.5 text-[12px] text-[rgba(43,27,18,0.55)]">
            ...
            <span className="text-[rgba(43,27,18,0.75)]">Site Settings</span>
            <span className="text-[rgba(43,27,18,0.3)]">›</span>
        ...
        <Link
          ...
          className="rounded-full bg-[var(--b-primary)] px-5 py-2.5 text-[13px] font-medium text-white shadow-[0_10px_24px_rgba(43,27,18,0.3)] transition-colors hover:bg-[var(--b-primary-deep)]"
        >
      ...
      {/* Table */}
      <div className="mt-6 overflow-x-auto rounded-2xl border border-[rgba(43,27,18,0.15)] bg-white shadow-[0_10px_30px_rgba(43,27,18,0.05)]">
        <table className="w-full text-left text-[13.5px]">
          ...
          <tbody>
            {row ? (
              <tr className="border-t border-[rgba(43,27,18,0.06)] transition-colors hover:bg-[var(--b-tint)]/60">
                ...
                <td className="px-5 py-3 align-middle font-medium text-[var(--b-ink)]">
                  {row.branding.brandName || <span className="text-[rgba(43,27,18,0.4)]">— not set —</span>}
                </td>
                <td className="max-w-[220px] truncate px-5 py-3 align-middle text-[rgba(43,27,18,0.75)]" title={row.hero.tagline}>
                  {row.hero.tagline || <span className="text-[rgba(43,27,18,0.35)]">—</span>}
                </td>
                <td className="max-w-[240px] truncate px-5 py-3 align-middle text-[var(--b-ink)]" title={row.hero.heroHeadline}>
                  {row.hero.heroHeadline || <span className="text-[rgba(43,27,18,0.35)]">—</span>}
                </td>
                <td className="px-5 py-3 align-middle">
                  {row.branding.logo ? (
                ...
                <td className="px-5 py-3 align-middle">
                  {row.branding.favicon ? (
                    <span className="inline-flex h-6 w-6 items-center justify-center overflow-hidden rounded-md border border-[rgba(43,27,18,0.1)] bg-[var(--b-tint)]">
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                ...
                <td className="px-5 py-3 align-middle text-[rgba(43,27,18,0.65)]">
                  {row.updatedAt ? new Date(row.updatedAt).toLocaleDateString() : "—"}
                </td>
                <td className="whitespace-nowrap px-5 py-3 text-right">
                  <Link
                    href="/admin/site-settings/edit"
                    className="inline-flex items-center gap-1 text-[12.5px] text-[var(--b-ink)] hover:underline"
                  >
              ...
              <tr>
                <td colSpan={8} className="px-5 py-10 text-center text-[rgba(43,27,18,0.45)]">
        ...
        {row ? (
          <div className="flex items-center justify-between border-t border-[rgba(43,27,18,0.08)] bg-[var(--b-tint)]/50 px-5 py-3 text-[12.5px] text-[rgba(43,27,18,0.7)]">
            <span>Showing 1 result</span>
            <span className="text-[rgba(43,27,18,0.5)]">Only one site-settings record exists.</span>
          </div>
        ) : null}
      </div>
    </div>
