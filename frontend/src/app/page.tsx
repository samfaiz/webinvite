  ...
  return (
    <div className="relative mx-auto h-[440px] w-[250px]">
      {SAMPLE_CARDS.map((c, i) => (
        ...
        >
          <div
            className="box-border flex h-[350px] w-[250px] flex-col items-center gap-[11px] rounded-md border p-[30px_22px] shadow-[0_26px_60px_rgba(43,58,103,0.3)]"
        ...
        <div className="flex h-[min(480px,calc(100vh-130px))] w-[360px] max-w-[calc(100vw-3.5rem)] flex-col overflow-hidden rounded-2xl border border-[rgba(111,138,184,0.25)] bg-white shadow-[0_30px_80px_rgba(74,28,46,0.35)]">
          ...
          >
            {msgs.length === 0 ? (
              <>
                <div
                  className="max-w-[85%] self-start rounded-[12px_12px_12px_4px] border border-[rgba(111,138,184,0.2)] bg-white px-3.5 py-3 text-[13.5px] font-light leading-[1.55] text-[#2b3a67]"
                  style={{ fontFamily: "var(--f-body)" }}
                >
                ...
                <div className="mt-1 flex flex-col gap-1.5">
                  {suggestions.map((s) => (
                    <button
                      key={s}
                      onClick={() => send(s)}
                      className="self-start rounded-full border border-[rgba(111,138,184,0.4)] bg-white px-3.5 py-2 text-[12.5px] font-normal text-[#5c7bb0] transition-colors hover:bg-[#f9dce9]"
                      style={{ fontFamily: "var(--f-body)" }}
                    >
                      {s}
                    </button>
              ...
              <div key={i} className="flex">
                {m.role === "user" ? (
                  <div
                    ...
                    style={{
                      background: "linear-gradient(135deg,#2b3a67,#5c7bb0)",
                  ...
                  <div
                    className="mr-auto max-w-[85%] whitespace-pre-wrap rounded-[12px_12px_12px_4px] border border-[rgba(111,138,184,0.2)] bg-white px-3.5 py-3 text-[13.5px] font-light leading-[1.55] text-[#2b3a67]"
                    style={{ fontFamily: "var(--f-body)" }}
                  >
                    {m.content}
                  </div>
            ...
            {busy ? (
              <div className="flex gap-1.5 self-start rounded-[12px_12px_12px_4px] border border-[rgba(111,138,184,0.2)] bg-white px-4 py-3.5">
                {[0, 1, 2].map((i) => (
                  <span
                    key={i}
                    className="h-1.5 w-1.5 rounded-full bg-[#5c7bb0]"
                    style={{
            ...
            {error ? (
              <div
                className="self-start rounded-[10px] border border-[rgba(43,58,103,0.4)] bg-[#e3eaf5] px-3.5 py-2 text-[12.5px] text-[#7a2418]"
                style={{ fontFamily: "var(--f-body)" }}
              >
                {error}
              </div>
          ...
          <div className="flex items-center gap-2.5 border-t border-[rgba(111,138,184,0.15)] bg-white p-3">
            <input
              ...
              className="flex-1 rounded-full border border-[rgba(43,58,103,0.2)] bg-[#eef2f8] px-4 py-2.5 text-[13.5px] font-light text-[#2b3a67] outline-none placeholder:text-[rgba(43,58,103,0.45)] focus:border-[#5c7bb0]"
              style={{ fontFamily: "var(--f-body)" }}
            />
            <button
              onClick={() => send()}
              ...
              className="flex h-10 w-10 flex-none items-center justify-center rounded-full bg-[#2b3a67] text-white transition-colors hover:bg-[#22305a] disabled:opacity-50"
            >
...
export default function Landing() {
  ...
  return (
    <div className="min-h-svh bg-[#f7f9fc] font-[var(--f-body)] text-[#2b3a67]">
      {/* top brand ribbon */}
      ...
      <nav className="mx-auto flex max-w-[1240px] items-center justify-between px-6 py-6 sm:px-16">
        <Link href="/" className="flex items-baseline gap-2">
          <span className="text-[26px] font-semibold italic text-[#2b3a67]" style={{ fontFamily: "var(--f-serif)" }}>
            Web Invite
          </span>
          <span className="h-[5px] w-[5px] rotate-45 bg-[#5c7bb0]" />
        </Link>
        <div className="flex items-center gap-4 text-[14px] tracking-[0.06em] text-[rgba(43,58,103,0.75)] sm:gap-8" style={{ fontFamily: "var(--f-body)" }}>
          <a href="#samples" className="hidden hover:text-[#2b3a67] sm:inline">Designs</a>
          <a href="#how" className="hidden hover:text-[#2b3a67] sm:inline">How it works</a>
          <a href="#pricing" className="hidden hover:text-[#2b3a67] md:inline">Pricing</a>
      ...
      <header className="relative">
        <div className="mx-auto flex max-w-[1240px] flex-col items-center gap-6 px-6 pb-8 pt-10 text-center sm:px-16 sm:pt-16">
          <div className="flex items-center gap-3 text-[11px] font-medium tracking-[0.3em] text-[#5c7bb0]" style={{ fontFamily: "var(--f-body)" }}>
          ...
          <h1
            className="max-w-[820px] text-balance text-[44px] font-medium italic leading-[1.06] text-[#2b3a67] sm:text-[64px] lg:text-[72px]"
            style={{ fontFamily: "var(--f-serif)" }}
          >
            Your celebration, <em className="text-[#2b3a67]">in full colour</em>
          </h1>

          <p
            className="max-w-[560px] text-pretty text-[16px] font-light leading-[1.65] text-[rgba(43,58,103,0.75)] sm:text-[18px]"
            style={{ fontFamily: "var(--f-body)" }}
          >
          ...
          <div className="mt-2 flex flex-wrap items-center justify-center gap-4">
            <Link
              href="/create"
              className="rounded-full px-9 py-4 text-[15px] font-medium tracking-[0.04em] shadow-[0_12px_30px_rgba(43,58,103,0.35)] transition hover:brightness-95"
              style={{ background: "var(--c-primary)", color: "var(--c-on-primary)" }}
            >
            ...
            <a
              href="#samples"
              className="rounded-full border border-[rgba(43,58,103,0.35)] px-7 py-4 text-[15px] font-normal text-[#2b3a67] transition-colors hover:border-[#2b3a67] hover:text-[#2b3a67]"
            >
              Browse designs
            </a>
          </div>

          <p className="text-[13px] font-light tracking-[0.06em] text-[rgba(43,58,103,0.5)]" style={{ fontFamily: "var(--f-body)" }}>
        ...
        <div className="relative mt-2 h-[460px]">
          ...
          <div className="pointer-events-none absolute inset-0" aria-hidden>
            {[
              { l: "20%", t: 50, s: 10, c: "#b08d57", r: false },
              { l: "14%", t: 190, s: 8, c: "#5c7bb0", r: false, d: -2, dur: 5 },
              { l: "27%", t: 300, s: 6, c: "#5c7bb0", r: true, d: -1.4, dur: 4.2 },
              { r2: "18%", t: 70, s: 8, c: "#5c7bb0", r: false, d: -1 },
              { r2: "24%", t: 280, s: 7, c: "#7a5ba6", r: true, d: -2.6, dur: 5.2 },
              { r2: "13%", t: 200, s: 11, c: "#b08d57", r: false, d: -3, dur: 5.5 },
            ].map((p, i) => (
              <span
                key={i}
                className="absolute"
          ...
          {/* RSVP toast */}
          <div
            className="pointer-events-none absolute left-4 bottom-14 flex items-center gap-2.5 rounded-full border border-[rgba(111,138,184,0.3)] bg-white py-2.5 pl-3 pr-4 shadow-[0_14px_34px_rgba(43,58,103,0.18)] sm:left-[10%]"
            style={{ animation: "wi-toast 8s ease-in-out infinite" }}
          >
            <span className="flex h-[26px] w-[26px] items-center justify-center rounded-full bg-[#5c7bb0] text-[12px] font-semibold text-white">P</span>
            <span className="text-[13px] font-normal text-[#2b3a67]" style={{ fontFamily: "var(--f-body)" }}>
              Priya replied <strong className="font-semibold text-[#5c7bb0]">Yes</strong> · +2 guests
            </span>
          </div>
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-3 bg-[#fbeed6] px-6 py-8 text-[12.5px] tracking-[0.14em] text-[#8a5f2a] sm:px-16" style={{ fontFamily: "var(--f-body)" }}>
        ...
        <span className="h-1.5 w-1.5 rotate-45 bg-[#2b3a67]" />
        <span>MUSIC &amp; ANIMATION</span>
        <span className="h-1.5 w-1.5 rotate-45 bg-[#5c7bb0]" />
      ...
      <section id="how" className="mx-auto max-w-[1140px] px-6 pb-16 pt-20 sm:px-16 sm:pb-20 sm:pt-24">
        <div className="mb-12 flex flex-col items-center gap-3 text-center">
          ...
          <h2 className="text-[34px] font-medium italic text-[#2b3a67] sm:text-[44px]" style={{ fontFamily: "var(--f-serif)" }}>
        ...
        <div className="grid gap-7 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            >
              ...
              <span className="text-[17px] font-medium text-[#2b3a67]" style={{ fontFamily: "var(--f-body)" }}>
                {c.title}
              </span>
              <p className="text-[14.5px] font-light leading-[1.65] text-[rgba(43,58,103,0.7)]" style={{ fontFamily: "var(--f-body)" }}>
                {c.body}
              </p>
            </div>
          ))}
      ...
      <section className="mx-auto max-w-[1140px] px-6 pb-20 sm:grid sm:grid-cols-2 sm:items-center sm:gap-16 sm:px-16">
        <div className="flex flex-col gap-3.5 rounded-2xl border border-[rgba(111,138,184,0.25)] bg-white p-7 shadow-[0_20px_50px_rgba(43,58,103,0.08)]">
          <div className="flex items-baseline justify-between">
            <span className="text-[12px] font-medium tracking-[0.18em] text-[rgba(43,58,103,0.55)]" style={{ fontFamily: "var(--f-body)" }}>
              GUEST LIST
            </span>
            <span className="text-[16px] font-medium italic text-[#5c7bb0]" style={{ fontFamily: "var(--f-serif)" }}>
              86 of 120 replied
            </span>
          </div>
          <div className="h-1.5 overflow-hidden rounded-full bg-[#f9dce9]">
            <span className="block h-full w-[72%]" style={{ background: "linear-gradient(90deg,#b08d57,#2b3a67,#5c7bb0)" }} />
          </div>
          {[
            ...
            <div key={r.name} className="flex items-center justify-between rounded-lg bg-[#eef2f8] px-4 py-3">
              <span className="text-[14px] text-[#2b3a67]" style={{ fontFamily: "var(--f-body)" }}>{r.name}</span>
          ...
          <div className="flex items-center gap-2.5 rounded-lg bg-[#f9dce9] px-4 py-3">
            <span className="flex h-[22px] w-[22px] items-center justify-center rounded-full bg-[#5c7bb0] text-[10px] font-semibold text-white">M</span>
            <span className="text-[14px] font-medium italic text-[#2b3a67]" style={{ fontFamily: "var(--f-serif)" }}>
        ...
        <div className="mt-10 flex max-w-[440px] flex-col gap-4 sm:mt-0">
          <span className="text-[11px] font-medium tracking-[0.28em] text-[#2b3a67]" style={{ fontFamily: "var(--f-body)" }}>
            LIVE RSVP
          </span>
          <h2 className="text-[34px] font-medium italic leading-[1.15] text-[#2b3a67] sm:text-[42px]" style={{ fontFamily: "var(--f-serif)" }}>
            Never chase a reply again
          </h2>
          <p className="text-pretty text-[16px] font-light leading-[1.7] text-[rgba(43,58,103,0.72)]" style={{ fontFamily: "var(--f-body)" }}>
          ...
          <Link
            href="/dashboard"
            className="mt-1 self-start rounded-full border border-[rgba(43,58,103,0.5)] px-6 py-3 text-[13px] font-medium tracking-[0.06em] text-[#2b3a67] transition-colors hover:bg-[#e3eaf5]"
            style={{ fontFamily: "var(--f-body)" }}
          >
            See the dashboard →
          </Link>
      ...
      <section className="bg-[#e8edf5]">
        <div className="mx-auto max-w-[1140px] px-6 py-20 sm:grid sm:grid-cols-2 sm:items-center sm:gap-16 sm:px-16 sm:py-24">
          <div className="flex max-w-[440px] flex-col gap-4">
            <span className="text-[11px] font-medium tracking-[0.28em] text-[#b08d57]" style={{ fontFamily: "var(--f-body)" }}>
              FULL CUSTOMIZATION
            </span>
            <h2 className="text-[34px] font-medium italic leading-[1.15] text-[#2b3a67] sm:text-[42px]" style={{ fontFamily: "var(--f-serif)" }}>
              Every detail, yours
          ...
          <div className="mt-10 flex flex-col gap-5 rounded-2xl border border-[rgba(198,141,44,0.3)] bg-white p-7 shadow-[0_20px_50px_rgba(43,58,103,0.08)] sm:mt-0">
            <div className="flex flex-col gap-2.5">
              <span className="text-[11px] font-medium tracking-[0.18em] text-[rgba(43,58,103,0.55)]" style={{ fontFamily: "var(--f-body)" }}>
                PALETTE
              </span>
              <div className="flex gap-2.5">
                {[
                  ...
                  <span
                    ...
                    style={{ background: s.c, border: s.ring ? "2px solid #2b3a67" : undefined }}
                  />
                ))}
              </div>
            </div>
            <div className="flex flex-col gap-2.5">
              ...
              <div className="flex flex-wrap gap-2.5">
                <span
                  className="rounded-lg border-[1.5px] border-[#2b3a67] bg-[#e3eaf5] px-4 py-2 text-[15px] font-medium italic text-[#2b3a67]"
                  style={{ fontFamily: "var(--f-serif)" }}
                >
                  Cormorant
                </span>
                <span
                  className="rounded-lg border border-[rgba(43,58,103,0.2)] px-4 py-2 text-[13px] text-[rgba(43,58,103,0.75)]"
                  style={{ fontFamily: "var(--f-body)" }}
                >
                  Jost
                </span>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <div className="flex items-center gap-3 rounded-lg bg-[#eef2f8] px-4 py-3">
                <span className="h-2 w-2 rounded-full bg-[#2b3a67]" style={{ animation: "wi-float 2s ease-in-out infinite" }} />
                <span className="text-[14px] text-[#2b3a67]" style={{ fontFamily: "var(--f-body)" }}>
      ...
      <section id="samples" className="mx-auto max-w-[1140px] px-6 py-20 sm:px-16 sm:py-24">
        <div className="mb-10 flex flex-col items-center gap-3 text-center">
          ...
          <p className="max-w-[520px] text-pretty text-[15.5px] font-light text-[rgba(43,58,103,0.7)]" style={{ fontFamily: "var(--f-body)" }}>
        ...
        {designs === null ? (
          <p className="mt-8 text-center text-[rgba(43,58,103,0.5)]" style={{ fontFamily: "var(--f-body)" }}>
            Loading designs…
          </p>
        ) : (
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {list.map((it) => (
              ...
              >
                ...
                <div className="flex flex-col gap-1 p-5">
                  <p className="text-[15px] font-medium text-[#2b3a67]" style={{ fontFamily: "var(--f-body)" }}>
                    {it.name}
                  </p>
                  <p className="text-[13px] text-[rgba(43,58,103,0.55)]" style={{ fontFamily: "var(--f-body)" }}>
            ...
            {list.length === 0 ? (
              <p className="col-span-full text-center text-[rgba(43,58,103,0.5)]" style={{ fontFamily: "var(--f-body)" }}>
        ...
        <p className="mt-10 text-center">
          <Link href="/gallery" className="text-[14px] text-[#5c7bb0] hover:text-[#2b3a67] hover:underline" style={{ fontFamily: "var(--f-body)" }}>
            Browse all designs →
          </Link>
        </p>
      </section>
      ...
      {/* Testimonial */}
      <section className="bg-[#2b3a67] px-6 py-20 text-center sm:px-16">
        <p
        ...
        <span className="mt-4 inline-block text-[12px] tracking-[0.22em] text-[#b08d57]" style={{ fontFamily: "var(--f-body)" }}>
      ...
      <section id="pricing" className="flex flex-col items-center gap-6 px-6 pb-16 pt-24 text-center sm:px-16">
        <h2 className="text-[38px] font-medium italic text-[#2b3a67] sm:text-[52px]" style={{ fontFamily: "var(--f-serif)" }}>
          Begin your invitation
        </h2>
        <p className="text-[16px] font-light text-[rgba(43,58,103,0.65)]" style={{ fontFamily: "var(--f-body)" }}>
          Free to start — pay only when you’re ready to share.
        </p>
        <Link
          href="/create"
          className="rounded-full px-10 py-4 text-[15px] font-medium tracking-[0.04em] shadow-[0_12px_30px_rgba(43,58,103,0.35)] transition hover:brightness-95"
          style={{ background: "var(--c-primary)", color: "var(--c-on-primary)" }}
        >
          Start free
        </Link>
        ...
        <div className="mx-auto grid max-w-[1240px] gap-10 px-6 py-16 sm:grid-cols-2 sm:px-16 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div className="flex max-w-[300px] flex-col gap-4">
            <div className="flex items-baseline gap-2">
              ...
              <span className="h-[5px] w-[5px] rotate-45 bg-[#b08d57]" />
            </div>
          ...
          {[
            ...
            <div key={col.title} className="flex flex-col gap-3.5">
              <span className="text-[11px] font-medium tracking-[0.24em] text-[#b08d57]" style={{ fontFamily: "var(--f-body)" }}>
                {col.title}
              </span>
              <div className="flex flex-col gap-2.5">
              ...
              <div className="flex flex-wrap items-center gap-2">
                {site!.social.links.filter((l) => l.url).map((l) => (
                  <a
                    ...
                    className="flex h-9 w-9 items-center justify-center rounded-full border border-[rgba(251,236,201,0.2)] text-[rgba(251,236,201,0.7)] transition-colors hover:border-[#b08d57] hover:text-[#b08d57]"
                  >
